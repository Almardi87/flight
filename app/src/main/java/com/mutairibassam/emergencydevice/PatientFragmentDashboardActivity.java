...
public class PatientFragmentDashboardActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        yData.add(new PieEntry(5, "Requests"));
        yData.add(new PieEntry(1, "Last week"));
        yData.add(new PieEntry(1, "Last month"));
        yData.add(new PieEntry(5, "Last year"));
